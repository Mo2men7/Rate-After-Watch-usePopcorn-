...
function MovieDetails({ selectedID, onCloseMovie, onAddWatched, watched }) {
  ...
  useKeyCode("Escape", onCloseMovie);
              ...
              {!isWatched ? (
                <>
                  <StarRating
                    ...
                    key={selectedID.concat(imdbRating)}
                  />
                  {userRating > 0 && (
                    <button className="btn-add" onClick={newWatched}>
                      + Add to list
                    </button>
                  )}
                </>
